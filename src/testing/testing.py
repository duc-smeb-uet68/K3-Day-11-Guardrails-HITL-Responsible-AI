...
#
# Run the same manual adversarial prompts against
...
async def run_comparison():
    ...
    # The deterministic layers protect the comparison without relying on a
    # judge network call.  The production assembly enables the separate judge.
